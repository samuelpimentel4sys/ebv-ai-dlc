...
| **Atualizado em** | 2026-07-28 14:10 (America/Sao_Paulo) |
| **Ambiente** | Java 21 · Spring Boot 3.4 · profiles `supabase,infra` |
| **Git** | S1–S3 em `origin/main` · **EP-02 lab 10/10** F01–F10 local (sem commit) |
...
1. `mvn test` + smoke HTTP F06–F09  
2. Commit/push EP-02 lab (quando pedir)  
3. EP-05 Contestação / Console B2B  
