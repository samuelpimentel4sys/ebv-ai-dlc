"""EP-03 F09 — routing policy / decisions / inference cost.

Revision ID: 004_ep03_f09
Revises: 003_ep03_f08
"""
...
revision: str = "004_ep03_f09"
down_revision: str | None = "003_ep03_f08"
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS public.tb_pj_inference_cost")
    op.execute("DROP TABLE IF EXISTS public.tb_pj_routing_decision")
    op.execute("DROP TABLE IF EXISTS public.tb_pj_routing_policy")
